...
#OutputFrame():
OutputFrame = tk.Frame(root, width = 500, height = 300, bg="green")
OutputFrame.grid(column=3)

#Text pane:
textPane = tk.Frame(root, width=500, height = 150, bg="red")
textPane.grid(column=3)

#Button pane:
buttonFrame = tk.Frame(root, width=200, height=200, bg="blue")
